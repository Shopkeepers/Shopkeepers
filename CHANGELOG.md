...
* Fix: Prevent shopkeeper mobs from being sheared by dispensers. Block drops were already prevented before, but other effects on the entity or the dispensed item were not prevented previously.
