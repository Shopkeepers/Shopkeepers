...
public interface PlayerProfile {
	 ...
	 * 
	 * @return the timestamp of when the player was first seen on the server, or {@link Instant#EPOCH} if unknown
	 */
	 ...
	 * 
	 * @return the timestamp of when the player was last seen on the server, or {@link Instant#EPOCH} if unknown
	 */
	 ...
	 * <p>
	 * This may update the last known name and the first-seen and last-seen timestamps.
	 * 
	 * @return the new and updated player profile
	 */
