package com.nisovin.shopkeepers.compat.v26_3_R1_paper;
...
public final class CompatProviderImpl implements CompatProvider {
	...
	public static final String VERSION_ID = "26_3_R1_paper";
	...
	public ItemStack deserializeItemStack(
		...
		return Unsafe.assertNonNull(CraftItemStack.asBukkitMirror(nmsItem));
	}
	...
	@Override
	public void setSulfurCubeSize(LivingEntity sulfurCube, int size) {
		((SulfurCube) sulfurCube).setSize(size);
	}
}
